...
object AppUtil {
    ...
    const val PREF_IS_PLAYING = "PREF_IS_PLAYING"
    const val PREF_ARTIST_NAME = "PREF_ARTIST_NAME"
    const val PREF_ALBUM_NAME = "PREF_ALBUM_NAME"
    const val PREF_PLAYLIST_ID = "PREF_PLAYLIST_ID"
    const val PREF_SOURCE_NAME = "PREF_SOURCE_NAME"
    const val PREF_IS_SHUFFLE_ENABLED = "PREF_IS_SHUFFLE_ENABLED"
